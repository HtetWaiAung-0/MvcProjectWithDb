...
<body>
	...
	<div class="container">
		<div class="sidenav">
			...
			<a>	Course Registration</a>  <a href="STU001.jsp">Student
					Registration </a> <a href="SearchStudentController">Student Search </a>
			</div>
			...
			<div id="sub_content">
				<form action="AddCourseController" method="post">
					...
					<div class="row mb-4">
						...
						request.setAttribute("finalCourseString", finalCourseString);
						
						%>
						
							<input type="text" class="form-control" id="id"
								value="${finalCourseString}" readonly name ="cId">
						</div>
					</div>
