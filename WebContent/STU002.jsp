...
<c:forEach items="${stuList}" var = "a">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" value="${a.stuId}" id="studentID" name = "stuId" readonly="readonly">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name" value="${a.stuName }" name = "stuName">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="date" class="form-control" id="dob" name = "stuDob" value="${a.stuDob }">
                </div>
            </div>
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="" name = "stuGender"
                            checked>
                    ...
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="option2" name = "stuGender">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="phone" value="${a.stuPhone }" name = "stuPhone">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="col-md-2"></div>
               ...
               <div class="col-md-4">
                    ...
                    <div class="form-check-inline col-md-2">
                        <input class="form-check-input" type="checkbox" name="stuAttend" id="gridRadios1" value="${data.courseName}" ${a.stuAttend.contains(data.courseName) ? 'checked' : '' }>
                        <label class="form-check-label" for="gridRadios1">
                           ${data.courseName}
    ...
    <a href="DeleteStudentController?stuId=${a.stuId}">
