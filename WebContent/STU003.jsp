...
<body>
  <div id="testheader">
    ...
    <div id="sub_content">
      <form class="row g-3 mt-3 ms-2" action="SearchStudentController" method="post">
        <div class="col-auto">
        ...
        <div class="col-auto">
            ...
            <input type="text" class="form-control" id="inputPassword2" placeholder="Education" name ="searchAttend">
          </div>
        <div class="col-auto">
      ...
      <table class="table table-striped" id="stduentTable">
        ...
        <c:set var="count" value="${count+1 }" scope="page"/>
          <tr>
            ...
            <td>${data.stuName}</td>
            <td>
           <c:forEach items="${data.stuAttend}" var = "a">
            ${a},
            </c:forEach>
            </td>
            <td>
              <a href="UpdateStudentController?stuId=${data.stuId }"><button type="button" class="btn btn-secondary mb-2">See More</button></a> 
            </td>
          </tr>
         </c:forEach>
        </tbody>
