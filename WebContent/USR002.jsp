...
<body>
    ...
    <div id="sub_content">
        ...
        <div class="row mb-4">
            ...
            <label for="email" class="col-md-2 col-form-label">UserID</label>
            <div class="col-md-4">
                <input type="text" class="form-control" id="id" value="${data.userId}" name="userId" readonly ="readonly">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="email" class="form-control" id="email" value="${data.userMail }" name="userMail">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="name"  name="userPassword">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
