...
<body>
    ...
    <div id="sub_content">
        <form action="SearchUserController" method ="post" class="row g-3 mt-3 ms-2">
            <div class="col-auto">
            ...
            <div class="col-auto">
                <label for="inputPassword2" class="visually-hidden">User Mail</label>
                <input type="text" class="form-control" id="inputPassword2" placeholder="User Name" name="searchMail">
            </div>
    ...
    <div>${errorFill}</div>
        <table class="table table-striped" id="stduentTable">
            ...
            <c:forEach items="${userList}" var = "data">
                ...
                <td>
                <a href="UpdateUserController?userId=${data.userId}">
                ...
                <td>
                <a href="DeleteUserController?uId=${data.userId}">
